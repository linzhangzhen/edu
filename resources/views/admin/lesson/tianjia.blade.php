...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   name="video_address" readonly="readonly">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<label class="form-label col-xs-4 col-sm-3"></label>
			<div class="formControls col-xs-8 col-sm-9">
				<img id="show_pic"  src="" width="220" height="110">
			</div>
			{{--用于接收上传图片的路径名--}}
			<label class="form-label col-xs-4 col-sm-3"></label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="" placeholder="" id="lesson_duration" name="lesson_duration">分钟
			</div>
		</div>
		{{--课时描述  文字域--}}
		<div class="row cl">
