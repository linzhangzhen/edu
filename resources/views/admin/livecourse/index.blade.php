...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 直播课程中心 <span class="c-gray en">&gt;</span> 直播课程管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="text-c"> 日期范围：
        ...
        <button type="submit" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜直播课程</button>
    </div>
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加直播课程','{{url('admin/livecourse/tianjia')}}','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加直播课程</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
    <div class="mt-20">
...
<script type="text/javascript">
    $(function(){
        ...
        mydatatable =  $('.table-sort').dataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{url('admin/livecourse/index')}}",
                "type": "POST",
            ...
            "columns": [
                ...
                {'data':'stream.stream_name'},   //通过关系查找出了stream表的数据
                {'data':'cover_img'}, 	  //封面图
                {"defaultContent":""},
                //{'data':'start_at'},
                {'data':'end_at'},
            ...
            "createdRow":function(row,data,dataIndex){
                ...
                var anniu = '\
				<a title="编辑" href="javascript:;" onclick="member_edit(\'编辑\',\'/admin/livecourse/xiugai/'+data.id+'\',4,\'\',510)" class="ml-5" style="text-decoration:none">\
                ...
                $(row).find('td:eq(4)').html(img_show);
    ...
    function show_video(lesson_id){
        layer_show('播放视频','/admin/livecourse/video_play/'+lesson_id,800,500);
    }
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '/admin/livecourse/del/'+id,		//地址把id带上
                dataType: 'json',
                headers:{
