...
<head>
    ...
    <title>添加直播课程 - H-ui.admin v3.1</title>
...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        {{--直播课程名  文字框--}}
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>直播课程名：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <img id="show_pic"  src="" width="220" height="110" alt="没有图片">
            </div>
            {{--用于接收上传图片的路径名--}}
            <label class="form-label col-xs-4 col-sm-3"></label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="cover_img" id="cover_img" class="input-text">
            </div>
        </div>
        ...
        {{--开始时间--}}
        <script src="/jedate/jquery.jedate.js" type="text/javascript"></script>
        <link rel="stylesheet" type="text/css" href="/jedate/skin/jedate.css">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>开始时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="start_at" id="start_at" class="input-text" readonly="readonly">
            </div>
        </div>
        {{--结束时间--}}
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="end_at" id="end_at" class="input-text" readonly="readonly">
            </div>
        </div>
        <script type="text/javascript">
            $("#start_at").jeDate({
        ...
        {{--课程直播描述  文字域--}}
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">课程直播描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
