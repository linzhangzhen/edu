...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 直播流中心 <span class="c-gray en">&gt;</span> 直播流管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="text-c"> 日期范围：
        ...
        <button type="submit" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜直播流</button>
    </div>
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加直播流','{{url('admin/stream/tianjia')}}','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加直播流</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
    <div class="mt-20">
    ...
    $(function(){
        ...
        mydatatable =  $('.table-sort').dataTable({
            ...
            "createdRow":function(row,data,dataIndex){
                ...
                var anniu = '\
				<a title="编辑" href="javascript:;" onclick="member_edit(\'编辑\',\'/admin/stream/xiugai/'+data.stream_id+'\',4,\'\',510)" class="ml-5" style="text-decoration:none">\
					<i class="Hui-iconfont">&#xe6df;</i>\
				</a>\
				<a title="删除" href="javascript:;" onclick="member_del(this,'+data.stream_id+')" class="ml-5" style="text-decoration:none">\
					<i class="Hui-iconfont">&#xe6e2;</i>\
				</a>';
                //把anniu填充给最后一个td
                $(row).find('td:eq(4)').html(anniu);
