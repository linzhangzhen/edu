...
<div class="container" style="background: #fff;">
    ...
    <div class="personal-content pull-right">
        <div class="personal-cont">
            ...
            <div class="my-course">
                <div class="tit"><span class="active hv-poin">直播课程</span>
                    <div class="cont">
                        @foreach($data as $k=>$v)
                            <div class="col-lg-6">
                                <div class="item">
                                    ...
                                    @if(time()>=$v->start_at && time()<=$v->end_at)
                                        <div class="text-center"><a href="#" class="btn btn-primary" onclick="alert('这是直播页')">进入直播</a></div>
                                    @endif
                                </div>
                            </div>
                        @endforeach
