    ...
    <div class="register">
        ...
        <div class="register-body">
            <div class="register-cent">
                ...
                <form class="required-validate" id="regStudentForm" action="{{url('home/student/login')}}" method="post">
                    {{csrf_field()}}
                    <ul class="r-position login">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" name="std_name" value="{{old('std_name')}}" placeholder="请输入登录名">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input type="password" class="form-control" name="password" value="{{old('password')}}" placeholder="请输入密码">
